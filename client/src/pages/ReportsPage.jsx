...
const ReportsPage = () => {
    ...
    const REPORTS = [
        { title: t('reports.mock.report1'), type: 'PDF', date: `${t('bills.months.may', { defaultValue: 'May' })} 2026`, size: '2.4 MB' },
        { title: t('reports.mock.report2'), type: 'PDF', date: `${t('bills.months.mar', { defaultValue: 'Mar' })} 2026`, size: '5.1 MB' },
        { title: t('reports.mock.report3'), type: 'CSV', date: 'YTD 2026', size: '124 KB' },
        { title: t('reports.mock.report4'), type: 'PDF', date: '2025', size: '8.2 MB' },
    ];
        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-4">
                    <h3 className="text-sm font-bold text-white mb-2">{t('reports.availableReports')}</h3>
                ...
                <div className="lg:col-span-2 bg-kashf-surface border border-kashf-border rounded-2xl p-6 lg:p-8 flex flex-col relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        <div>
                            <span className="px-2.5 py-1 bg-neutral-800 text-neutral-300 text-xs font-bold uppercase tracking-wider rounded-md mb-3 inline-block">{t('reports.preview')}</span>
                    ...
                    <div className="flex-1 bg-neutral-900 border border-neutral-800 rounded-xl p-6 sm:p-10 relative z-10 aspect-[1/1.1] shadow-inner overflow-hidden flex flex-col">
                        <div className="flex justify-between items-center border-b border-neutral-800 pb-6 mb-6">
                            ...
                            <div className={`text-sm text-neutral-500 ${document.documentElement.dir === 'rtl' ? 'text-left' : 'text-right'}`}>
                                <p>{t('reports.reportDate')}: {t('bills.months.jun', { defaultValue: 'Jun' })} 01, 2026</p>
                                <p>{t('reports.meterId')}: 1029384756</p>
                            </div>
                        </div>
                        
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            <div className="bg-neutral-800/50 p-4 rounded-lg border border-neutral-700/50">
                                <p className="text-xs text-neutral-500 uppercase tracking-wider mb-1">{t('reports.totalConsumption')}</p>
                                <p className="text-2xl font-bold text-white" dir="ltr">420 <span className="text-sm font-normal text-neutral-500">kWh</span></p>
                            </div>
                            <div className="bg-neutral-800/50 p-4 rounded-lg border border-neutral-700/50">
                                <p className="text-xs text-neutral-500 uppercase tracking-wider mb-1">{t('reports.finalSheriha')}</p>
                                <p className="text-2xl font-bold text-amber-400">{t('common.tier', { tier: 5, defaultValue: 'Tier 5' })}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 flex-1">
                            ...
                            <div className="h-32 w-full bg-neutral-800/50 rounded flex flex-col items-center justify-center border border-neutral-800">
                                ...
                                <span className="text-xs text-neutral-500">{t('reports.chartArea')}</span>
                            </div>
