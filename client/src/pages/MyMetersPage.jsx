    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-white">My Meters</h1>
                    <p className="text-neutral-400 text-sm mt-1">Manage and monitor all your connected electricity meters.</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <button className="border-2 border-dashed border-neutral-800 hover:border-kashf-blue/50 bg-neutral-900/20 hover:bg-kashf-blue/5 rounded-2xl p-6 flex flex-col items-center justify-center min-h-[300px] transition-all group">
                    ...
                    <h3 className="text-lg font-medium text-white mb-1">Register New Meter</h3>
                    <p className="text-sm text-neutral-400 text-center max-w-xs">Add another property or sub-meter to track its consumption.</p>
                </button>
            </div>
        </div>
    );
    ...
    return (
        <div className="bg-kashf-surface border border-kashf-border rounded-2xl p-6 flex flex-col hover:border-neutral-700 transition-colors">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    <p className="text-xs text-neutral-500 mb-1">Current Tier</p>
                    <p className="text-xl font-bold text-amber-400">Tier {meter.tier}</p>
                </div>
                <div>
                    <p className="text-xs text-neutral-500 mb-1">Last Reading</p>
